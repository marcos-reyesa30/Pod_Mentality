...
# ----------------------------------------------
model_path = 'runs/pose/yolo11n_pose_cpu/weights/best.pt'  # Path to your best.pt file
if torch.cuda.is_available():
    model_path = 'runs/pose/yolo11n_pose_gpu/weights/best.pt'
...
test_dir = Path('datasets/coco-pose/images/val2017')
