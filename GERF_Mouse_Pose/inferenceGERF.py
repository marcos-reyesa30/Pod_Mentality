...
# 1. Load the Model
# ----------------------------------------------
model_path = 'runs/pose/yolo11gerf_mouse_cpu/weights/best.pt'
if torch.cuda.is_available():
    model_path = 'runs/pose/yolo11gerf_mouse_gpu/weights/best.pt'
...
test_dir = Path('datasets/mouse-pose/val/images')
